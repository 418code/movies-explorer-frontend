      ...
      <nav className="Menu__nav">
        ...
        <ul className="Menu__list">
          ...
          <li className="Menu__list-item" key="saved-movies">
            <Link to="/saved" className="App__link App__link_position_menu App__link_size_large">Сохранённые фильмы</Link>
          </li>
        </ul>
        <Link to="/account" className="App__link App__link_position_menu App__link_style_btn-rnd App__link_size_med">Аккаунт</Link>
      </nav>
    </div>
  );
}
