...
export default function Header(props) {
  ...
  return (
    <header className="Header">
      <Link to="/">
        <img src={logo} alt={intl.formatMessage({id: 'logo'})} className="Header__logo" />
      </Link>
      {isLoggedIn ?
                          <>
                            ...
                            <nav className="Header__nav">
                              <ul className="Header__list">
                                <li className="Header__list-item Header__list-item_space_close" key="movies">
                                  <Link to="/movies" className="App__link App__link_position_header App__link_size_pmed">
                                    {intl.formatMessage({id: 'movies'})}
                                  </Link>
                                </li>
                                <li className="Header__list-item" key="saved-movies">
                                  <Link to="/saved-movies" className="App__link App__link_size_pmed">
                                    {intl.formatMessage({id: 'saved_movies'})}
                                  </Link>
                                </li>
                              </ul>
                              <Link to="/profile" className="App__link App__link_position_header App__link_style_btn-rnd App__link_size_med">
                        ...
                        :
                          <ul className="Header__list">
                            ...
                            <li className="Header__list-item" key="sign-in">
                              <Link to="/signin" className="App__link App__link_position_header App__link_style_btn">
