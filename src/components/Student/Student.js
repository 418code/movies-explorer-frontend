    ...
    <section id="student" className="Landing__section Student">
      ...
      <article className="Student__article">
        ...
        <h3 className="Landing__text Student__text Student__text_weight_bold">
          {intl.formatMessage({
            id: "fe_dev",
            defaultMessage: "Фронтенд-разработчик",
          })}
        </h3>
      ...
      <ul className="App__list Student__list Student__list_vertical">
          ...
          <ul className="App__list Student__list Student__list_size_large">
            <li key="rutravel">
              ...
              >
                {intl.formatMessage({
                  id: "responsive",
                  defaultMessage: "Адаптивный сайт",
                })}
              </a>
            </li>
        ...
        <li className="Student__list-item">
          <ul className="App__list Student__list Student__list_size_large">
            <li key="mesto">
              <a
                href="https://github.com/418code/react-mesto-frontend"
                target="_blank"
                rel="noreferrer"
                className="App__link"
              >
                {intl.formatMessage({
                  id: "spa",
                  defaultMessage: "Одностраничное приложение",
                })}
              </a>
            </li>
            <li key="mesto-arrow">
